              ...
              <div class="card-body">
                <form action="add" id="user-add-form" method="post" class="row">
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="" placeholder="请输入友情链接名称" tips="请填写友情链接名称" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">URL</span>
                    <input class="form-control required" id="url" name="url" placeholder="请输入友情链接URL" tips="请填写友情链接URL">
                  </div>
                  <div class="input-group m-b-10">
